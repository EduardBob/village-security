...
public class DateTimePicker extends RelativeLayout implements View.OnClickListener, DatePicker.OnDateChangedListener, TimePicker.OnTimeChangedListener {
    ...
    public DateTimePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        datePicker.getResources().updateConfiguration(config, getContext().getResources().getDisplayMetrics());
        ...
        timePicker.getResources().updateConfiguration(config, getContext().getResources().getDisplayMetrics());
    ...
    public void reset(boolean first,String dateFrom) {
        ...
        if(first) {
            ...
            Calendar cc = DateUtils.getCalendarFromDate(dateFrom,DateUtils.DATE_FORMAT_24);
            time = cc.getTimeInMillis()+1800000;
        }
    ...
    public void setDateAndTime(String date){
        ...
        final Calendar c = DateUtils.getCalendarFromDate(date);
        updateDate(c.get(Calendar.YEAR), c.get(Calendar.MONTH), c.get(Calendar.DAY_OF_MONTH));
        updateTime(c.get(Calendar.HOUR_OF_DAY), c.get(Calendar.MINUTE));
    }
